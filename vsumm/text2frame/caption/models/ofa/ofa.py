...
@register_model_architecture("caption", "ofa_large")
...
@register_model_architecture("caption", "ofa_base")
...
@register_model_architecture("caption", "ofa_huge")
...
@register_model_architecture("caption", "ofa_medium")
...
@register_model_architecture("caption", "ofa_tiny")
def ofa_medium_architecture(args):
